							...
							<div class="mail-grids">
								...
								<div class="mail-bottom">
                                    ...
                                    @method('POST')
                                        ...
                                        <input type="email" value="mail" name="mail" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'Email';}" required="">

                                        <input type="text" value="phone" name="phone" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'Telephone';}" required="">
