...
<html>
<head>
<title>Get Ankara Products at affordable price!</title>
<!--css-->
...
@yield('content')
		...
		<!---footer--->
						...
						<div class="container">
							<div class="footer-grids">
								<div class="col-md-3 footer-grid">
									<h4>About </h4>
									<p>We deliver Countrywide! Our services are open 24/7. Get your Ankara Favourites e.g. Hayes Empire at affordable prices</p>
								...
								<div class="col-md-3 footer-grid">
									...
									<ul>
										...
										<li><a href="registered.html"> Make enquries </a></li>
									</ul>
								</div>
								<div class="col-md-3 footer-grid">
									<h4>PRODUCTS</h4>
									<ul>
										<li><a href="index.html">Ladies Outfits</a></li>
										<li><a href="products.html">Mens' outfits</a></li>
										<li><a href="codes.html">handbags</a></li>
										<li><a href="mail.html">Shoes</a></li>
										<li><a href="products1.html">Shambala</a></li>
									</ul>
								</div>
					...
					<div class="copy-section">
						<div class="container">
							<div class="copy-left">
								<p>&copy; 2016 Ankara Products . All rights reserved | Design by <a href="http://w3layouts.com">Alice Njororge</a></p>
							</div>
